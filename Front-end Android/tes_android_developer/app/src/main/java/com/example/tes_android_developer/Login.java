...
public class Login extends AppCompatActivity {
    ...
    public void CheckLogin(final String username, final String password) {
        if (checkNetworkConnection()) {
            ...
            SimpleDateFormat sdf1 = new SimpleDateFormat("d-M-yyyy h:m:s");
            //SimpleDateFormat sdf1 = new SimpleDateFormat("HH:mm:ss");
            final String strdate1 = sdf1.format(c1.getTime());
            StringRequest stringRequest = new StringRequest(Request.Method.POST, adapter.SERVER_LOGIN_URL,
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                if (resp.equals("[{\"status\":\"OK\"}]")) {
                                    ...
                                    dashboardIntent.putExtra("waktu", strdate1);
            ...
            Connection.getInstance(Login.this).addToRequestQue(stringRequest);
